...
def main():
    ...
    try:
        ...
        interactive_filename = f"{ticker}_interactive_graph.html"
        dplt.plot_interactive_graph(stock_data, interactive_filename)

        print(f"Интерактивный график сохранен как {interactive_filename}. Откройте этот файл в веб-браузере.")
